    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="guest_count" mb="4" isInvalid={!!formik.errors?.guest_count}>
            ...
            {formik.errors.guest_count && <FormErrorMessage>{formik.errors?.guest_count}</FormErrorMessage>}
          </FormControl>
