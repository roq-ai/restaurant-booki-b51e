...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiCoffee, FiCalendar } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Menu', path: '/menus', entity: 'menu', service: AccessServiceEnum.PROJECT, icon: FiMenu },
    {
      name: 'Reservation',
      path: '/reservations',
      entity: 'reservation',
